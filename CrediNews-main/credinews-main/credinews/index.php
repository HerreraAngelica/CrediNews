        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead mb-4">CrediNews uses advanced AI algorithms to analyze and verify news articles, helping you distinguish fact from fiction.</p>
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="assets/images/hero-image.svg" alt="AI News Verification" class="img-fluid rounded shadow-lg">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <p class="small">Subscribe to our newsletter for updates</p>
                    <form>
